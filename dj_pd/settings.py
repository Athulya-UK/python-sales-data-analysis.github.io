...
SECRET_KEY = '5(1lwc8!nd_m$9kdsxd-eou0%3(a!#eg6trh*=zsee(tkb0mri'
...
MEDIA_URL='/media/'
MEDIA_ROOT=os.path.join(os.path.dirname(BASE_DIR),"static_cdn","meida_root")
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER='execute@gmail.com'
